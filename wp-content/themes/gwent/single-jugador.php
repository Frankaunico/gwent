...
<div class="row col-12">
    ...
    <div class="col-12">
        <div class="col-12 col-xl-6 offset-xl-3 perfil-jugador">
            <div class="col-12 col-xl-8 offset-xl-2">
                <?php if ($jugador->imagenJugador()): ?>
            ...
            <div class="col-12 texto-centrado">
                <?php if ($equipo = $jugador->equipo()): ?>
                    <h3 class="color-texto texto-regular"><?php echo $equipo;?></h3>
                <?php endif; ?>
            </div>
    ...
    <div class="col-12 col-xl-4">
        <div class="margen-abajo">
            ...
            <?php if ($nombreCarta = $jugador->cartaFavorita()->nombreCarta()): ?>
                <h4 class="color-texto texto-regular"><?php echo $nombreCarta;?></h4>
            <?php endif; ?>
        </div>

        <?php if ($imagenCarta = $jugador->cartaFavorita()->imagenCarta()): ?>
            <div class="imagen-carta-o-faccion">
    ...
    <div class="col-12 col-xl-4">
        <div class="margen-abajo">
            ...
            <?php if ($nombreFaccion = $jugador->faccionFavorita()->nombreFaccion()): ?>
                <h4 class="color-texto texto-regular"><?php echo $nombreFaccion;?></h4>
            <?php endif; ?>
        </div>
